    ...
    <body>
        <div class="container">
            <span class="status-reason">
                <i class="fa fa-cogs fa-2x"></i> Under Maintenance
            </span>
        </div>
            ...
            <div class="container">
                <div class="additional-info-items">
                    ...
                    <div class="reason-text">
                        We are currently undergoing maintenance to enhance our services. We will be back online shortly.
                    </div>
                    <center><a href="//www.interserver.net/r/2304"><img
                                src="https://www.interserver.net/logos/12946800.gif"
                                alt="InterServer Web Hosting and VPS"></a></center>
                </div>
            </div>
        </section>
    </body>
